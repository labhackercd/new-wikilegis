...
urlpatterns = [
    ...
    path('feedback/authorization/management/<uuid:hash>/',
         views.FeedbackAuthorizationManagementView.as_view(),
         name="management_authorization"),
    path('feedback/unauthorization/management/<uuid:hash>/',
         views.FeedbackUnauthorizationManagementView.as_view(),
         name="management_unauthorization"),
    path('read/',
